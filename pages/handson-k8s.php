...
<head>
  <?php
    // Globals
    $title = "Hands-On Intro to Kubernetes";
    $url = "http://javascripteverything.com/landing/handson-k8s.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/handson-k8s.jpg";
    $image = "http://www.javascripteverything.com/landing/assets/openshift.png";
    $conference = "DevOps.js";
    $conferenceLink = "https://www.nodeconfremote.com/";
    $date = "March 22, 2021";
    $eventHashtag = "#DevOpsJS";

    $linksLine1 = "Thank you for attending this hands-on intro on Kubernetes. I hope you've enjoyed it. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "http://kubernetes.io", "text" => "Kubernetes official doc"],
      ["link" => "https://www.cncf.io/phippy/", "text" => "Phippy and Friends"],
      ["link" => "https://katacoda.com/courses/kubernetes", "text" => "Kubernetes Katacoda"]
    ];
    ...
    switch ($slideType) {
      case "container": 
        $slideText = "Looking for my slides? You won't be able to see them as a PDF but... there is a containerized version! You can start the slide deck with <br/><br/><i>docker run -it joellord/handson-k8s</i>";
        $slideLink = ["link" => "https://hub.docker.com/repository/docker/joellord/handson-k8s", "text" => "Slides container on Docker Hub"];
        break;
      case "diorama": 
        $slideText = "Looking for my slides? You won't be able to see them as a PDF but you can run the react application locally.";
        $slideLink = ["link" => "https://github.com/joellord/kube-kitchen", "text" => "Slide Deck"];
        break;
      default:
    ...
    $codeLink = ["link" => "https://github.com/joellord/handson-k8s", "text" => "Code samples on Github"];
  ?>
