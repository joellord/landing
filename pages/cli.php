...
<head>
  <?php
    ...
    $url = "http://javascripteverything.com/landing/cli.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/cli.jpg";
    $image = "http://www.javascripteverything.com/landing/assets/mongodb.png";
    $conference = "International JavaScript Conference - Munich";
    $conferenceLink = "https://javascript-conference.com/";
    $date = "October 25, 2021";
    $eventHashtag = "#iJSCon";

    $linksLine1 = "You now know everything you need to build awesome CLI tools with Node.js, get coding! I hope you've enjoyed the talk. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "https://nodejs.org/docs/latest-v14.x/api/", "text" => "Official NodeJS Documentation"],
      ["link" => "https://medium.com/netscape/a-guide-to-create-a-nodejs-command-line-package-c2166ad0452e", "text" => "Creating NodeJS CLI packages"],
      ["link" => "https://wiki-dev.bash-hackers.org/scripting/terminalcodes", "text" => "Escape codes in terminal"]
    ];
    ...
    switch ($slideType) {
      case "container": 
        ...
        $slideLink = ["link" => "https://hub.docker.com/repository/docker/joellord/node-cli", "text" => "Slides container on Docker Hub"];
        break;
      default:
    ...
    $codeLink = ["link" => "https://github.com/joellord/node-cli", "text" => "Code samples on Github"];
  ?>
...
<?
$title = "Biulding CLI Tools With NodeJS";
$description = "Additional resources for my talk '".$title."'";
$url = "http://www.javascripteverything.com/landing/cli.php";
$image = "http://www.javascripteverything.com/landing/assets/openshift.png";
$slides = "https://github.com/joellord/containers-talk";

$conference = "jsDay Verona";
$location = "The Internets";
$when = "September 10, 2020";

$moreText = "
  Run the slides in a container because... why not?<br>
  <pre><code>
  docker pull joellord/node-cli
  docker run -it joellord/node-cli
  </code></pre>
  <br/><br/>
  Interested in knowing more about CLI tools?<br>
  Look up those resources:<br>
  <ul>
    <li><a href='https://nodejs.org/docs/latest-v10.x/api/'>Official NodeJS (v.10) Documentation</a></li>
    <li><a href='https://medium.com/netscape/a-guide-to-create-a-nodejs-command-line-package-c2166ad0452e'>Creating NodeJS CLI packages</a></li>
    <li><a href='https://wiki-dev.bash-hackers.org/scripting/terminalcodes'>Escape codes in terminal</a></li>
  </ul><br/>
";
?>
