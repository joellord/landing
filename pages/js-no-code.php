...
<head>
  <?php
    ...
    $url = "http://javascripteverything.com/landing/js-no-code.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/no-code.jpg";
    $image = "http://www.javascripteverything.com/landing/assets/mongodb.png";
    $conference = "OpenJS World";
    $conferenceLink = "https://openjsf.org";
    $date = "June 2, 2021";
    $eventHashtag = "#openJS";
    
    $linksLine1 = "Thank you for attending my talk about IoT and Low-Code interfaces. I hope you've enjoyed it. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "https://www.espruino.com/WiFi", "text" => "Espruino Wifi"],
      ["link" => "https://www.raspberrypi.org/products/raspberry-pi-4-model-b/", "text" => "Raspberry Pi 4"],
      ["link" => "http://ifttt.com/", "text" => "IFTTT"],
      ["link" => "https://nodered.org/", "text" => "Node-RED"]
    ];
    ...
    switch ($slideType) {
      ...
      case "diorama": 
        ...
        $slideLink = ["link" => "https://github.com/joellord/js-no-code", "text" => "Slide Deck"];
        break;
      default:
    ...
    $codeLink = ["link" => "https://github.com/joellord/js-no-code", "text" => "Code samples on Github"];
  ?>
