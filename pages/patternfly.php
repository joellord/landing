...
<head>
  <?php
    // Globals
    $title = "PatternFly Passes with Flying Colours";
    $url = "http://javascripteverything.com/landing/patternfly.php";
    ...
    $conference = "GIDS";
    $conferenceLink = "https://codegen2021.azurewebsites.net/";
    $date = "April 26, 2021";
    $eventHashtag = "#GIDS";

    $linksLine1 = "Thank you for attending my talk about PatternFly. I hope you've enjoyed it. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "https://www.patternfly.org/v4/community", "text" => "Join the Community"],
      ["link" => "https://github.com/patternfly/patternfly-tutorial", "text" => "PatternFly Tutorial"],
      ["link" => "https://katacoda.com/patternfly", "text" => "Katacoda Scenarios"]
    ];
    ...
    switch ($slideType) {
      ...
      case "diorama": 
        ...
        $slideLink = ["link" => "https://github.com/joellord/pf-presentation", "text" => "Slide Deck"];
        break;
      default:
    ...
    $codeLink = ["link" => "https://github.com/joellord/pf-presentation", "text" => "Code samples on Github"];
  ?>
