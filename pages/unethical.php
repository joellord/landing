...
<head>
  <?php
    ...
    $url = "http://javascripteverything.com/landing/unethical.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/unethical.jpg";
    ...
    $linksLine1 = "Thank you for attending my talk about unethical face recognition. I hope you've enjoyed it. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "https://www.youtube.com/watch?v=Q4AmXuUFKCA", "text" => "Containerization For Software Developers (video)"],
      ["link" => "https://www.youtube.com/watch?v=g5YnA6vzZus", "text" => "Kubernetes Kitchen (video)"],
      ["link" => "https://www.rabbitmq.com/getstarted.html", "text" => "Rabbit MQ Getting Started Guide"],
      ["link" => "https://github.com/justadudewhohacks/face-api.js", "text" => "Face-api.js Code and Live Demo"],
      ["link" => "https://entwickler.de/docker/docker-cheat-sheet", "text" => "Docker Cheat Sheet on Entwickler.de"]
    ];
    ...
    $codeLink = ["link" => "https://github.com/joellord/node-ml-k8s", "text" => "Code samples on Github"];
  ?>
