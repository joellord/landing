...
<head>
  <?php
    // Globals
    $title = "IoT, JavaScript and Beer Brewing: Cheers!";
    $url = "http://javascripteverything.com/landing/cheers.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/cheers.jpg";
    $image = "http://www.javascripteverything.com/landing/assets/mongodb.png";
    $conference = "Connect.Tech";
    $conferenceLink = "https://www.connect.tech";
    $date = "November 10, 2021";
    $eventHashtag = "#ConnectTech";

    $linksLine1 = "Thank you for attending my talk about beer brewing and IoT. I hope you've enjoyed it. If so, please <a href='https://twitter.com/joel__lord'>Tweet about it</a>.";
    $links = [
      ["link" => "https://www.mongodb.com/cloud/atlas/register", "text" => "Try out MongoDB"],
      ["link" => "https://www.github.com/joellord/iot-js-beer", "text" => "Slides and code"],
      ["link" => "https://docs.google.com/presentation/d/1ytFSJXWACBtTNMgyFsiiyBAkPfruMiCeoQ_0QPFBQ_s/edit?usp=sharing", "text" => "Beer 101"]
    ];
    ...
    switch ($slideType) {
      ...
      case "diorama": 
        ...
        $slideLink = ["link" => "https://github.com/joellord/iot-js-beer", "text" => "Slide Deck"];
        break;
      default:
    ...
    $codeLink = ["link" => "https://github.com/joellord/iot-js-beer", "text" => "Code samples on Github"];
  ?>
