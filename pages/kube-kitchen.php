...
<head>
  <?php
    // Globals
    $title = "Kubernetes Kitchen";
    $url = "http://javascripteverything.com/landing/kube-kitchen.php";
    $description = "Additional resources for my talk ".$title;
    $bgImage = "assets/kube-kitchen.jpg";
    ...
    $links = [
      ...
      ["link" => "https://cloud.google.com/kubernetes-engine/kubernetes-comic/", "text" => "Google Cloud K8s Comic"],
      ["link" => "https://www.cncf.io/phippy/", "text" => "Phippy and Friends"],
      ["link" => "http://ezurl.to/digitalocean", "text" => "Try out Digital Ocean Kubernetes with 100$ free credits"]
    ];
    ...
    $codeLink = ["link" => "https://github.com/joellord/kube-kitchen", "text" => "Code samples on Github"];
  ?>
